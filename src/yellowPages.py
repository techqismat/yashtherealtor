...
def parse_listing(keyword, place):
    ...
    """
    url = "https://www.yellowpages.ca/search?search_terms={0}&geo_location_terms={1}".format(keyword, place)
...
if __name__ == "__main__":
    ...
    if scraped_data:
        print("Writing scraped data to %s-%s-yellowpages-scraped-data.json" % (keyword, place))
